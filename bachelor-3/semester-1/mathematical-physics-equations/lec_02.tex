\lecture{2}{Пт 11 сен 2020 13:48}{Введение в функциональное исчисление операторов в гильбертовом пр-ве}
\lec
...
При этом также по определению оптопроектора очевидно, что
