...
\centering
	...
	\footnotetext{\url{https://upload.wikimedia.org/wikipedia/commons/e/e3/Three_Key_Factors_Required_for_a_Respirator_to_be_Effective.pdf}}
...
\frametitle{\insertsection}
\centering
\includegraphics[width=0.5\textwidth]{2}\footnotetext{\url{https://bonafidemasks.com/Powecom-kn-95/}}
...
\frametitle{\insertsection}
\centering
\includegraphics[width=0.8\textwidth]{31}\footnotetext{\url{https://www.cdc.gov/niosh/npptl/pdfs/facialhairwmask11282017-508.pdf}}
...
\begin{exampleblock}{}
  ...
  \vskip5mm
  \hspace*\fill{\small Kimberly Prather,}\\
  \hspace*\fill{\small aerosol expert}
\end{exampleblock}
\end{frame}
